...
allowed-tools: Bash(codewiki search:*)
---
...
Run `codewiki search "$ARGUMENTS" --limit 20` in `${workspaceFolder}` and present
the top results as a table with columns: Kind, Name, File, Module.
